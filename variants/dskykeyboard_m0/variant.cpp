...
const PinDescription g_APinDescription[]=
{
  ...
  // digital pins in SAMD21E "PA" order definitions for PA00 to PA28
  ...
  { PORTA, 26, PIO_DIGITAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, 
